...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/sagitoptal/checkers/checkers/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<CheckersQueryParamsResponse, RpcStatus>({
      path: `/sagitoptal/checkers/checkers/params`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/sagitoptal/checkers/checkers/stored_game
   */
  queryStoredGameAll = (
    query?: {
    ...
    this.request<CheckersQueryAllStoredGameResponse, RpcStatus>({
      path: `/sagitoptal/checkers/checkers/stored_game`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/sagitoptal/checkers/checkers/stored_game/{index}
   */
  queryStoredGame = (index: string, params: RequestParams = {}) =>
    this.request<CheckersQueryGetStoredGameResponse, RpcStatus>({
      path: `/sagitoptal/checkers/checkers/stored_game/${index}`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/sagitoptal/checkers/checkers/system_info
   */
  querySystemInfo = (params: RequestParams = {}) =>
    this.request<CheckersQueryGetSystemInfoResponse, RpcStatus>({
      path: `/sagitoptal/checkers/checkers/system_info`,
      method: "GET",
      format: "json",
      ...params,
    });
